...
#ifndef LIBRARIES_LIBERAMOX_ERRORMGMT_H_
#define LIBRARIES_LIBERAMOX_ERRORMGMT_H_
...
public:
	/*
	 * \enum RetValue to specify the different
	 *       errors which can happen
	 */
	enum RetValue{
		RETOK,  /* No error occured */
...
#endif /* LIBRARIES_LIBERAMOX_ERRORMGMT_H_ */
